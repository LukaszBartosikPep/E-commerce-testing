...
public enum EnvironmentEnums {
    ...
    User,Password, Backpack, Name, LastName, Postal,PerformanceGlitchUser, ProblemUserLogin, StandardUser, CheckoutStepOneUrl,CheckoutStepTwoUrl,HomePageUrl, Baterie, Jezyk, LiczbaSztuk, SamsungS23;
